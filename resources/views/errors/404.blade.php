...
<body>
        ...
        <div class="container">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <p>You will be automatically redirected to home page after <span id="counter"></span>
                    </p>
                    <a href="{{ url('/') }}"><button class="btn green">HOME</button></a>
                </div>
            </div>
        </div>
    </main>
    ...
    <script src="{{ asset('js/scripter.js') }}"></script>
