                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input id="email" class="form-control email-input" type="email" name="email" placeholder="Email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    <button class="btn btn-primary btn-block" type="submit" onclick="validateItem()">Register</button>
                                </div>
                            </form>
