...
<div class="content container-fluid">
    ...
    <div class="box inform_css">
        <div class="back-to-profile">
            <p><a class="back" href="{{ route('admin.profile') }}">🡠 Back</a></p>
        </div>
            ...
            <div class="col-lg-12">
                <form method="post" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row formtype">
                        <div class="col-md-1">
                            <div class="form-group">
                                <img id="showImage" src="{{ (!empty($editData->profile_photo_path))? url('images/upload_images/admin_images/'.$editData->profile_photo_path): url('images/upload_images/no_avatar.png') }}" alt="" width="100" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
