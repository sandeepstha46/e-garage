                ...
                <div class="col-md-6">
                    <ul class="top-head-second-row">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <li><a class="dropdown-item" href="/">Request Spare Parts</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                ...
                <div class="col-md-6">
                    <div class="row inner-fouth">
                        <div class="col-md-7">
                            ...
                            <p>An unserviced vehicle is likely to have a shorter life expectancy and higher fuel costs. Getting your car regularly serviced could save you money in the long run.</p>
                ...
                <div class="col-md-6">
                    <div class="row inner-fouth">
                        <div class="col-md-7">
                            ...
                            <p>We have the time to explain every job, and always provide you with an estimate in advance. You can be rest assured that our technicians have been trained.</p>
                            <button class="btn btn-primary book-now">Book Now</button>
                        </div>
                        <div class="col-md-5">
                ...
                <div class="col-md-6">
                    <div class="row inner-fouth">
                        <div class="col-md-7">
                            ...
                            <p>An auto painting job requires a certain level of expertise and experience. By having your car painted by a professional, you are assured of best results.</p>
                            <button class="btn btn-primary book-now">Book Now</button>
                        </div>
                        <div class="col-md-5">
                ...
                <div class="col-md-6">
                    <div class="row inner-fouth">
                        <div class="col-md-7">
                            ...
                            <p>Proper detailing improves and maintains the health of your car. While detailing takes a bit of effort, the benefits to reliability, safety and beauty are all worthwhile.</p>
                            <button class="btn btn-primary book-now">Book Now</button>
                        </div>
                        <div class="col-md-5">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active text-center">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 ms-3"><i>"This is some content from a media component. You can replace this with any content and adjust it as needed."</i></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div id="emailHelp" class="form-text">Get up-to-date information and about new offers. Always be on top to get updates and offers.</div>
                            </div>
                        </div>
                    </div>
                </div>
